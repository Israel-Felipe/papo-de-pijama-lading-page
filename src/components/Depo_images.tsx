  ...
  return (
    <header className="relative flex flex-col justify-center items-center h-auto bg-[#E89D9B] z-0 overflow-hidden">
      ...
      <nav className="relative h-auto max-w-screen-xl mb-12 flex flex-col items-center justify-center w-[85%]">
        <p
          className="w-full lg:text-5xl text-3xl text-center !leading-tight font-bold mt-16 text-[#FEF4E6]"
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center lg:px-0 mt-8 md:mt-14 gap-6 lg:gap-[2%]">
          <Image
            src={depo1}
            className={'w-[85%] md:w-[32%] rounded-xl'}
            alt="depoimento 1"
          />
          <Image
            src={depo2}
