...
export default function FAQ() {
  return (
    <header className="flex justify-center bg-[#E4795B] z-0 lg:p-28 pt-40">
      <nav className="w-auto h-auto mt-0 max-w-screen-xl lg:w-full text-[#FEF4E6] flex flex-col justify-start items-center lg:items-start">
        ...
        <div className="lg:w-full w-[90%] flex flex-col justify-center items-center mt-40 gap-8">
          ...
          <h2 className="text-[#751133] lg:text-4xl text-xl text-center lg:w-[59%] lg:leading-[3rem]">
            Acesse o link abaixo para conversar comigo por WhatsApp
          </h2>

          <div className="relative lg:w-[70%] h-auto m-auto z-10 mb-12">
            <a
              href="https://api.whatsapp.com/send?phone=5547999906082&text=Oi%20Paola.%20Eu%20preciso%20de%20ajuda%20para%20saber%20mais%20sobre%20o%20papo%20de%20pijama!"
              className="w-full"
            >
              <button
...
function BlocsFAQ({ title, text }: { title: string; text: string }) {
  ...
  return (
    <nav>
      <div
        className="z-40 relative cursor-pointer flex lg:justify-start items-center"
